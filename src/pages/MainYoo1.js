...
const MainYoo1 = () => {
  ...
  // 지도에 마커를 표시하는 함수입니다(AI mode off) 수정해야함

  function displayMarker2(i) {
    var imageSrc = "img/tl2.png", // 마커이미지의 주소입니다
      imageSize = new kakao.maps.Size(65, 28), // 마커이미지의 크기입니다
  ...
  function displayMarker(i) {
    var imageSrc = "img/tl.png", // 마커이미지의 주소입니다
      imageSize = new kakao.maps.Size(28, 58), // 마커이미지의 크기입니다
      imageOption = { offset: new kakao.maps.Point(27, 69) }; // 마커이미지의 옵션입니다. 마커의 좌표와 일치시킬 이미지 안에서의 좌표를 설정합니다.
    // 마커의 이미지를 생성합니다.
    var markerImage = new kakao.maps.MarkerImage(
      imageSrc,
          ...
          <div className="menulist-wrapper">
            <nav className="menulist">
              ...
              <div className="error">
                ...
                <div className="tittle12">
                  {`최신 오류 내역 : ${problem[0].error_name}`}
                  <br></br>
                  {`발생 날짜 : ${problem[0].error_date.substring(0, 10)}`}
                </div>
                <div className="morepolice" onClick={onMoreErrorContainerClick}>
                  <div className="morepolice-child" />
                  <div className="morepolice-child" />
                  <img
              ...
              <div className="info">
                <div className="police-child" />
                <div className="police-child" />
                <div className="tiaddress">
                  {`선택 신호등 위치 : ${data.address}`}
                </div>
                <div className="tlinfo">
                  {`선택 신호등 정보 : ${data.title}`}
                </div>
                <div className="columns2">
                  <div className="div23">신호등 정보</div>
                </div>
              ...
              <div className="addbtn">
                <div className="columns3" onClick={openAdd}>
